    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody class="table-group-divider">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <a type="button" class="btn-link" style="color: #17a2b8" data-bs-toggle="modal" data-bs-target="#adminCursoModal<?php echo $clase; ?>">
                ...
                <div class="modal fade" id="adminCursoModal<?php echo $clase; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
