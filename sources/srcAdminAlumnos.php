    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody class="table-group-divider">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <a type="button" class="btn-link" style="color: #17a2b8" data-bs-toggle="modal" data-bs-target="#adminAlumnoModal<?php echo $email; ?>">
                ...
                <div class="modal fade" id="adminAlumnoModal<?php echo $email; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
