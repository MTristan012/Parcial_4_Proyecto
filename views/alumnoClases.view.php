        ...
        <aside class="d-flex flex-column flex-shrink-0 p-3 vh-100" style="background-color: #343a40;">
            ...
            <div style="color:#bec3cc;">
                ...
                if ($_SESSION['permiso'] == 1) {
                    ...
                    echo '<p><span class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
                    ...
                    echo '<p><span class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-workspace"    viewBox="0 0 16 16">
                    ...
                    echo '<p><span class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                    ...
                    echo '<p><span class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-easel2" viewBox="0 0 16 16">
                    ...
                    echo '<p><span class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
                    <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"/>
                        <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z"/>
                        </svg></span> Ver Calificaciones</p>';
                    echo '<p><span class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-easel" viewBox="0 0 16 16">
                        <path d="M8 0a.5.5 0 0 1 .473.337L9.046 2H14a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-1.85l1.323 3.837a.5.5 0 1 1-.946.326L11.092 11H8.5v3a.5.5 0 0 1-1 0v-3H4.908l-1.435 4.163a.5.5 0 1 1-.946-.326L3.85 11H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h4.954L7.527.337A.5.5 0 0 1 8 0zM2 3v7h12V3H2z"/>
                        </svg></span> Administra tus Clases</p>';
                }
                ?>
        ...
        <section style="width:100%;">
                                ...
                                <li class="d-flex align-items-center container">
                                    ...
                                    if ($_SESSION['permiso'] == 2) {
                                        echo '
                                            ...
                                            <a class="dropdown-item" href="./main.view.php">Perfil</a>
                                        ';
                                        echo '
                                        <li>
            ...
            <section style="background-color: #f4f6f9; height:90%;" class="m-0">
                <div class="d-flex justify-content-between">
                    ...
                    <p class="me-2 my-auto"><a href="#">Home</a> / Dashboard</p>
                </div>
